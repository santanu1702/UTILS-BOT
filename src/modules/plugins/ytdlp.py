...
_bgutil_provider_value = getenv('BGUTIL_PROVIDER_URL') or 'bgutil-provider:4416'
bgutil_provider_url = (
    _bgutil_provider_value
    if '://' in _bgutil_provider_value
    else f'http://{_bgutil_provider_value}'
)
